...
public class MessageControllerTest {
    ...
    public void getExampleMessage() throws Exception {
        ...
        Assert.isTrue(content.equals("Ejemplo de respuesta"), "Descripción del mensaje OK");
    }

    //desafío
    @Test
    public void getMessageDescription() throws Exception {
        ...
        Assert.isTrue(messages.size() == 3, "Tamaño de la lista es 3");
    }

    //desafío
    @Test
    public void getMessageDescriptionEmpty() throws Exception {
        var result = mockMvc.perform(get("/coder-house/mensajes?description="))
                .andDo(print())
                .andExpect(status().isOk())
                .andReturn();
        ...
        Assert.notNull(messages, "Lista de mensajes no nula");
        Assert.isTrue(messages.isEmpty(), "Lista de mensajes vacía");
    }
